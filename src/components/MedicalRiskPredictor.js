...
// import { Heart, User, Activity, FlaskConical, Stethoscope, Check, X } from 'lucide-react';

// // A redesigned, more professional toggle switch component
...
//     const { prediction_text, risk_level, confidence } = resultData.prediction;
//     const { patientName, age, bmi, gestationalAge, doctorName } = resultData.patientInfo;

//     const riskColor = risk_level === "High Risk" ? "bg-red-100 text-red-800" : "bg-green-100 text-green-800";
//     const riskBorderColor = risk_level === "High Risk" ? "border-red-500" : "border-green-500";

//     return (
//         <div className="bg-white shadow-lg rounded-b-xl animate-fade-in">
//             <header className="bg-gray-50 p-6 border-b border-gray-200 rounded-t-xl">
...
//                     <p className={`text-2xl font-bold mt-2 ${risk_level === 'High Risk' ? 'text-red-600' : 'text-green-600'}`}>{risk_level}</p>
...
//                          <div className="text-sm space-y-3">
//                             <p><strong>Blood Pressure:</strong> {resultData.patientInfo.systolicBP} / {resultData.patientInfo.diastolicBP} mmHg</p>
//                             <p><strong>Hemoglobin:</strong> {resultData.patientInfo.hemoglobin} g/dL</p>
//                             <p><strong>Blood Glucose:</strong> {resultData.patientInfo.bloodGlucose} mg/dL</p>
//                          </div>
//                     </div>
//                 </div>
...
//     // In a real application, you would send formData to your ML model endpoint
//     console.log("Generating prediction with data:", formData);
//     alert('AI Prediction Generated! (This would connect to your ML model)');
//   };
// try {
...
//           {/* Maternal Health Risk Assessment Banner */}
...
//                     className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 outline-none transition-shadow"
//                   />
//                 </div>
//                 <div>
...
//                   onChange={(e) => handleInputChange('previousMiscarriages', e.target.value)}
//                   className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 outline-none transition-shadow"
//                 />
//               </div>
//             </section>

//             {/* Vital Signs & Laboratory Values Section */}
//             <section className="p-6 border-b border-gray-200">
//               <div className="flex items-center space-x-3 mb-5">
...
//                   <input type="number" placeholder="e.g., 120" value={formData.systolicBP} onChange={(e) => handleInputChange('systolicBP', e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow" />
//                 </div>
//                 <div>
//                   <label className="block text-sm font-medium text-gray-600 mb-2">Diastolic BP (mmHg)</label>
//                   <input type="number" placeholder="e.g., 80" value={formData.diastolicBP} onChange={(e) => handleInputChange('diastolicBP', e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow" />
//                 </div>
//                 <div>
//                   <label className="block text-sm font-medium text-gray-600 mb-2">Hemoglobin (g/dL)</label>
//                   <input type="number" step="0.1" placeholder="e.g., 13.5" value={formData.hemoglobin} onChange={(e) => handleInputChange('hemoglobin', e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow" />
//                 </div>
//                 <div>
//                   <label className="block text-sm font-medium text-gray-600 mb-2">Urine Protein (mg/dL)</label>
//                   <input type="number" placeholder="e.g., 150" value={formData.urineProtein} onChange={(e) => handleInputChange('urineProtein', e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow" />
//                 </div>
//                 <div>
//                   <label className="block text-sm font-medium text-gray-600 mb-2">Blood Glucose (mg/dL)</label>
//                   <input type="number" placeholder="e.g., 90" value={formData.bloodGlucose} onChange={(e) => handleInputChange('bloodGlucose', e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow" />
//                 </div>
//               </div>
//             </section>
...
//                   <input type="text" placeholder="Enter doctor's full name" value={formData.doctorName} onChange={(e) => handleInputChange('doctorName', e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-shadow" />
//                 </div>
//                 <div>
//                   <label className="block text-sm font-medium text-gray-600 mb-2">Doctor's Email</label>
//                   <input type="email" placeholder="doctor@hospital.com" value={formData.doctorEmail} onChange={(e) => handleInputChange('doctorEmail', e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-shadow" />
//                 </div>
//               </div>
//             </section>
...
//                 <button
//                   type="submit"
//                   className="bg-gradient-to-r from-teal-500 to-cyan-500 text-white px-8 py-3 rounded-lg font-semibold hover:from-teal-600 hover:to-cyan-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center space-x-2 mx-auto"
//                 >
